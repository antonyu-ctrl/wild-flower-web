...
const postSlugs = [
  { slug: 'the-art-of-linen', key: 'linenArt', image: '/products/Change_it_to_portrait_2k_delpmaspu.png', date: '2026-02-15' },
  { slug: 'spring-styling-guide', key: 'springMeadow', image: '/products/Korean_girl_with_black_hairis_walking_in_the_city__delpmaspu.png', date: '2026-02-01' },
  { slug: 'meet-our-embroidery-artisan', key: 'meetMaria', image: '/products/shoes3.png', date: '2026-01-20' },
  { slug: 'caring-for-natural-fibers', key: 'naturalFibers', image: '/products/bag1.png', date: '2026-01-10' },
  { slug: 'slow-fashion-wardrobe', key: 'slowFashion', image: '/products/accessories4.png', date: '2025-12-28' },
  { slug: 'winter-layering', key: 'winterLayering', image: '/products/bag5.png', date: '2025-12-15' },
];
...
export default function JournalPage() {
  ...
  const posts = postSlugs.map((p) => {
    const postT = t.pages.journal.posts[p.key as keyof typeof t.pages.journal.posts] as { title: string; excerpt: string; category: string };
    return {
      slug: p.slug,
      title: postT.title,
  ...
  return (
    <Container className="py-4 md:py-6">
      <Breadcrumb items={[{ label: t.pages.journal.title }]} />
